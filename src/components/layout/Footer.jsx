...
const Footer = () => {
    ...
    return (
        <>
                        ...
                        <div className="row g-lg-4 gy-5 justify-content-center">
                            ...
                            <div className="col-lg-2 col-md-4 col-sm-6 d-flex justify-content-lg-center justify-content-md-end">
                                <div className="footer-widget">
                                    ...
                                    <ul className="widget-list">
                                        ...
                                        <li><Link href="/global-visa">Visa Package</Link></li>
                                        <li><Link href="/visa-guide">Visa Guide</Link></li>
                                    ...
                                    <div className="single-content">
                                        <div className="contact-button">
                                            ...
                                            <div className="chat-us-btn">
                                                <a href={`https://api.whatsapp.com/send/?phone=${footerData.data.whatsapp_number}&text=Hello! Can I get more info about **`}>Chat With Us</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-3">
                                <div className="footer-widget">
                                    ...
                                    <div className="icon">
                                        <ul>
                                            <li><img src="/assets/image/tabby.png" alt="" /></li>
                                ...
                                return(
                                    ...
                                    <div key={index} className={`col-lg-4 position-relative ${index >= 1 ? 'divider' : ''}`}>
                                        <div className="footer-bottom-content">
                                            ...
                                            <div className='contact-info' href="#" dangerouslySetInnerHTML={{__html:office.address}}></div>
                                        </div>
                                    </div>
                                )
                            })}
            ...
            <a href={`https://api.whatsapp.com/send/?phone=${footerData.data.whatsapp_number}&text=Hello! Can I get more info about **`}><img src="/assets/image/whatsapp-click-to-chat.png" alt=""  /></a>
                    
                {/* <div className="contact-button">
                    <div className="chat-us-btn">
                        <a href={`https://api.whatsapp.com/send/?phone=${footerData.data.phone}&text=Hello! Can I get more info about **`}><div className="whatsup-icon">
