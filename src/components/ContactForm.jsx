  ...
  const handleChange = (e) => {
   ...
   const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${base_url}api/contact/message/send`, formData, {
                headers: {
            ...
            <div className="col-lg-5">
                <div className="single-contact mb-40">
                    ...
                    <div className="content">
                        ...
                        <h6>
                            <a href={`tel: ${contactData.data.contact_details.phone}`}>{contactData.data.contact_details.phone}</a>
                        </h6>
                ...
                <div className="single-contact mb-40">
                    ...
                    <div className="content">
                        <h6>
                            <a href={`mailto:${contactData.data.contact_details.email}`}>{contactData.data.contact_details.email}</a>
                        </h6>

                    </div>
                </div>
                {/* {
                    addres.slice(0,1).map((single_addess) => {
                        return <div className="single-contact mb-40">
                            <div className="title">
                                <h6>{single_addess.office_name}</h6>
                            </div>
                            <div className="icon">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="content">
                                <h6 dangerouslySetInnerHTML={{ __html: single_addess.address }}></h6>
                            </div>
                        </div>
                    })
                } */}
                <div className="single-contact mb-40">
                    ...
                    <div className="content">
                        <h6 dangerouslySetInnerHTML={{ __html: contactData.data.contact_details.address }}></h6>
                    </div>
                </div>
            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12 mb-20">
                                <div className="form-inner">
                                    <label>Name*</label>
                                    <input name='name' required value={formData.name} onChange={(e)=>handleChange(e)} type="text" placeholder="Daniel Scoot" />
                                </div>
                            </div>
                            <div className="col-lg-6 mb-20">
                                <div className="form-inner">
                                    <label>Phone</label>
                                    <input name='phone' required value={formData.phone} onChange={(e)=>handleChange(e)} type="text" placeholder="Phone Number..." />
                                </div>
                            </div>
                            <div className="col-lg-6 mb-20">
                                <div className="form-inner">
                                    <label>Email</label>
                                    <input name='email' required value={formData.email} onChange={(e)=>handleChange(e)} type="email" placeholder="Email Us...." />
                                </div>
                            </div>
                            <div className="col-lg-12 mb-30">
                                <div className="form-inner">
                                    ...
                                    <textarea
                                    name='message' value={formData.message} onChange={(e)=>handleChange(e)}
